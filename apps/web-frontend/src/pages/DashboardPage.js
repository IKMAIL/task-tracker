...
export default function DashboardPage() {
  const { data: summary, loading: l1, error: e1 } = useFetch(getSummary);
  const { data: alerts,  loading: l2, error: e2 } = useFetch(listAlerts);
  const { data: teams,   loading: l3, error: e3 } = useFetch(listTeams);
